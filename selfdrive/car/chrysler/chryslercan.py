...
def create_lkas_hud(packer, CP, lkas_active, hud_alert, hud_count, car_model, auto_high_beam, aolc_enabled):
  ...
  color = 2 if lkas_active else 1 if aolc_enabled and not lkas_active else 0
