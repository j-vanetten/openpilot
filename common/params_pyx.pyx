...
keys = {
  ...
  b"jvePilot.settings.accFollow1RadarRatio": [TxType.PERSISTENT],
  b"jvePilot.settings.accFollow2RadarRatio": [TxType.PERSISTENT],
  b"jvePilot.settings.accFollow3RadarRatio": [TxType.PERSISTENT],
  b"jvePilot.settings.accFollow4RadarRatio": [TxType.PERSISTENT],
