...
keys = {
  ...
  b"jvePilot.settings.accEco.speedAheadLevel1": [TxType.PERSISTENT],
  b"jvePilot.settings.accEco.speedAheadLevel2": [TxType.PERSISTENT],
  b"jvePilot.settings.accEco.accFollow1RadarRatio": [TxType.PERSISTENT],
  b"jvePilot.settings.accEco.accFollow2RadarRatio": [TxType.PERSISTENT],
  b"jvePilot.settings.accEco.accFollow3RadarRatio": [TxType.PERSISTENT],
  b"jvePilot.settings.accEco.accFollow4RadarRatio": [TxType.PERSISTENT],
  b"jvePilot.settings.autoFollow": [TxType.PERSISTENT],
  b"jvePilot.settings.autoFollow.speed1-2Bars": [TxType.PERSISTENT],
  b"jvePilot.settings.autoFollow.speed2-3Bars": [TxType.PERSISTENT],
  b"jvePilot.settings.autoFollow.speed3-4Bars": [TxType.PERSISTENT],
  b"jvePilot.settings.autoResume": [TxType.PERSISTENT],
  b"jvePilot.settings.disableOnGas": [TxType.PERSISTENT],
  b"jvePilot.settings.deviceOffset": [TxType.PERSISTENT],
